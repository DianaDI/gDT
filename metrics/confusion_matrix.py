...
# Source: https://github.com/drprojects/DeepViewAgg/blob/a5aae0b2e308ec9afa111303fcb01b65ddc55f17/torch_points3d/metrics/confusion_matrix.py
...
class ConfusionMatrix:
    ...
    def count_predicted_batch(self, ground_truth_vec, predicted):
        #assert max(predicted) < self.number_of_labels
